...
void deff(){
    arr[2][0] = 6; arr[2][1] = 2; arr[2][2] = 4; arr[2][3] = 8;
    arr[3][0] = 1; arr[3][1] = 3; arr[3][2] = 9; arr[3][3] = 7;
    arr[4][0] = 6; arr[4][1] = 4;
    arr[7][0] = 1; arr[7][1] = 7; arr[7][2] = 9; arr[7][3] = 3;
    arr[8][0] = 6; arr[8][1] = 8; arr[8][2] = 4; arr[8][3] = 2;
    arr[9][0] = 1; arr[9][1] = 9;
}
